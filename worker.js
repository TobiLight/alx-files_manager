...
userQueue.process(async (job, done) => {
  ...
  const user = await (await dbClient.getUserCollections())
  ...
  // try {
  //   const mailSubject = 'Welcome to ALX-Files_Manager by 0xTobii';
  //   const mailContent = [
  //     '<div>',
  //     '<h3>Hello {{user.name}},</h3>',
  //     'Welcome to <a href="https://github.com/TobiLight/alx-files_manager">',
  //     'ALX-Files_Manager</a>, ',
  //     'a simple file management API built with Node.js by ',
  //     '<a href="https://github.com/TobiLight">Oluwatobiloba Light</a>. ',
  //     '</div>',
  //   ].join('');
